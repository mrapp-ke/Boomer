...
class IRuleModelAssemblageFactory {
    ...
    public:
         ...
         *
         * @param statisticsProviderFactory         A shared pointer to an object of type `IStatisticsProviderFactory`
         *                                          that provides access to the statistics which serve as the basis for
         *                                          learning rules
         * @param thresholdsFactory                 A shared pointer to an object of type `IThresholdsFactory` that
         *                                          allows to create objects that provide access to the thresholds that
         ...
         * @param instanceSamplingFactory           A shared pointer to an object of type `IInstanceSamplingFactory`
         *                                          that allows create the implementation to be used for sampling the
         *                                          examples whenever a new rule is induced
         * @param featureSamplingFactory            A shared pointer to an object of type `IFeatureSamplingFactory` that
         *                                          allows to create the implementation to be used for sampling the
         *                                          features that may be used by the conditions of a rule
         * @param partitionSamplingFactory          A shared pointer to an object of type `IPartitionSamplingFactory`
         *                                          that allows to create the implementation to be used for partitioning
         *                                          the training examples into a training set and a holdout set
         * @param pruning                           A shared pointer to an object of type `IPruning` that should be used
         *                                          to prune the rules
         * @param postProcessor                     A shared pointer to an object of type `IPostProcessor` that should
