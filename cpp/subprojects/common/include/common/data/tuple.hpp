...
struct Tuple final {
    public:
        ...
        /**
         * Creates and returns a new tuple that results from adding the first and second value of a specific tuple to
        ...
        /**
         * Creates and returns a new tuple that results from subtracting a specific value from the first and second
         * value of an existing tuple, respectively.
         *
         * @param lhs   The original tuple
         * @param rhs   A reference to the value to be subtracted
         * @return      The tuple that has been created
        ...
        /**
         * Creates and returns a new tuple that results from subtracting the first and second value of a specific tuple
         * from the first and second value of an existing tuple, respectively.
         *
         * @param lhs   The original tuple
         * @param rhs   A reference to the value to be subtracted
         * @return      The tuple that has been created
